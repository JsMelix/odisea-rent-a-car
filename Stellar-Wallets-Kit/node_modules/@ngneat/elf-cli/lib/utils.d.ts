...
export declare function resolveStoreVariableName(template: Options['template'], { propertyName }: ReturnType<typeof names>, inlineStoreInClass?: Options['inlineStoreInClass']): string;
/**
